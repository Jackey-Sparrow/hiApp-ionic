...
!function(t){"use strict";t.module("hiApp.contacts").factory("contactHttpService",["$http","$q",function(t,n){var c={};return c.getAllContacts=function(){var c=n.defer();return t.get("contacts/contacts.json").then(function(t){c.resolve(t.data)},function(t){c.reject(t)}),c.promise},c}])}(angular);
...
!function(e){"use strict";e.module("hiApp.tweet").factory("tweetCommentService",["$http","$q",function(e,t){var n={},r=[];return n.getCommentByTweetId=function(n){var o=t.defer();return e.get("tweet/comments.json").then(function(e){r=e.data;var t=r.filter(function(e){return e.tweetId===n});o.resolve(t)},function(e){console.log(e),o.reject(e)}),o.promise},n}])}(angular);
!function(t){"use strict";t.module("hiApp.tweet").factory("tweetDetailService",[function(){var t={};return t}])}(angular);
!function(t){"use strict";t.module("hiApp.tweet").factory("tweetService",["$q","$http",function(t,e){var n={},r=[];return n.setList=function(t){r=t},n.getList=function(){return r},n.getTweetById=function(t){var e=r.filter(function(e){return e.id===t});return e.length?e[0]:null},n.getTweetByPagination=function(n){var r=n.pageNumber,i=n.pageSize,o=r*i,u=(r+1)*i,a=t.defer();return e.get("tweet/tweet.json").then(function(t){var e=t.data.length,n={totalCount:e,main:t.data.slice(o,u)};a.resolve(n)},function(t){console.log(t)}),a.promise},n}])}(angular);
